...
import { Access_Course_Content, Add_Review, Answer_Question, Ask_Question, Delete_Course, Edit_Course, Get_All_Courses, Get_Courses, Get_Single_Course, Reply_Review, Upload_Course } from '../Controller/course.controller.js'
const router = express.Router()


router.route('/upload').post(Verify_User,Authorize_Role('admin'),Upload_Course)
router.route('/edit/:id').post(Verify_User,Authorize_Role('admin'),Edit_Course)
